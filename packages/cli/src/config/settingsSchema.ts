...
const SETTINGS_SCHEMA = {
  ...
  openaiCompatibleProviders: {
    ...
    default: {},
    description:
      'Saved OpenAI-compatible provider configurations. Each key is a provider name, ' +
      'value has baseUrl, apiKey (optional), and defaultModel.',
    showInDialog: false,
  },
  ...
  activeProvider: {
    ...
    requiresRestart: false,
    default: {},
    description: 'The currently active provider configuration.',
    showInDialog: false,
    properties: {
      id: {
        type: 'string',
        ...
        requiresRestart: false,
        default: 'google',
        description: 'The active provider id (e.g. google, openai-compatible).',
        showInDialog: false,
      },
      name: {
        type: 'string',
        ...
        requiresRestart: false,
        default: '',
        description: 'The display name of the saved provider entry.',
        showInDialog: false,
      },
    },
  },
