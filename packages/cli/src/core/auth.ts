...
export async function performInitialAuth(
  ...
  // If a non-Google provider (e.g. openai-compatible) has already been
  // activated on startup, skip Google auth — refreshAuth would overwrite
  // the provider's content generator with a Google one.
