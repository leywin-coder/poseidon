...
export function renderPreamble(options?: PreambleOptions): string {
  ...
  const base = options.interactive
    ? 'You are Poseidon CLI, an interactive CLI agent specializing in software engineering tasks.'
    : 'You are Poseidon CLI, an autonomous CLI agent specializing in software engineering tasks.';
