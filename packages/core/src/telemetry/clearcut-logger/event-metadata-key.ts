...
export enum EventMetadataKey {
  ...
  // Logs the Surface from where the Poseidon CLI was invoked, eg: VSCode.
  GEMINI_CLI_SURFACE = 39,

  // Logs the session id
  GEMINI_CLI_SESSION_ID = 40,

  // Logs the Poseidon CLI version
  GEMINI_CLI_VERSION = 54,

  // Logs the Poseidon CLI Git commit hash
  GEMINI_CLI_GIT_COMMIT_HASH = 55,

  // Logs the Poseidon CLI OS
  GEMINI_CLI_OS = 82,
