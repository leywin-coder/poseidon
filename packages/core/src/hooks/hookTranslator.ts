...
/**
 * Decoupled LLM request format - stable across Poseidon CLI versions
 */
...
/**
 * Decoupled LLM response format - stable across Poseidon CLI versions
 */
...
/**
 * Decoupled tool configuration - stable across Poseidon CLI versions
 */
